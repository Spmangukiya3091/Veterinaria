...
router.get("/singleOwner/:id", Secure(["masterAdmin", "customerService", "user"]), ownerController.getSingleOwner);
router.get("/petListByOwner/:id", Secure(["masterAdmin", "customerService", "user"]), ownerController.getAllPetsByOwner);
router.get("/ownerFilter", Secure(["masterAdmin", "customerService", "user"]), ownerController.ownerFilter);
