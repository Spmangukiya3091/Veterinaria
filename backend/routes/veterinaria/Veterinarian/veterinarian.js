...
router.get("/veterinariansAppointmentList", Secure(["masterAdmin", "customerService"]), veterinarianController.appointmentData);
router.get(
  "/singleVeterinarianAppointment/:id",
  Secure(["masterAdmin", "customerService", "user"]),
  veterinarianController.appointmentDataBySingleVeterinarian,
);
router.get("/singleVeterinarian/:id", Secure(["masterAdmin", "user"]), veterinarianController.getSingleVeterinarians);
router.get("/veterinariansExcelSheet", Secure(["masterAdmin"]), veterinarianController.veterinarianExcelFile);
router.get("/veterinariansFilter", Secure(["masterAdmin"]), veterinarianController.veterinarianFilter);
router.post("/createVeterinarian", Secure(["masterAdmin"]), uploadAvatar.single("avatar"), veterinarianController.createVeterinarian);
router.put("/UpdateVeterinarian/:id", Secure(["masterAdmin"]), uploadAvatar.single("avatar"), veterinarianController.updateVeterinarian);
router.delete("/veterinarianRemove/:id", Secure(["masterAdmin"]), veterinarianController.deleteVeterinarian);
