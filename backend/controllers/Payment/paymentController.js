...
const registerPayment = async (req, res) => {
  try {
    ...
    const payment = {
      ...
      transfer_no: req.body.transfer_no === "" || !req.body.transfer_no ? null : req.body.transfer_no,
      owner: req.body.owner === "" || !req.body.owner ? null : req.body.owner,
      doctor: req.body.doctor === "" || !req.body.doctor ? null : req.body.doctor,
    ...
    } else if (payment.payment_method === "" || payment.payment_method === null) {
      res.status(400).send({
