            ...
            <table className="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_products_table" >
              ...
              <tbody>
                {currentPosts ? (
                  currentPosts.map(
                    (
                      { COD, MASCOTA, HORARIO, FECHA, ESTADO, ACCIONES },
                      i
                    ) => (
                      <tr key={i}>
                        ...
                        <td className="text-end">
                          <a href={`/customerservice/citas-view?status=${ESTADO}`} className="btn btn-sm btn-light btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">{ACCIONES}
                          </a>
                        </td>
                      </tr>
                    )
