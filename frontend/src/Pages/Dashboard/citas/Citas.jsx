...
function Citas({ email }) {
  ...
  const handleExportData = async () => {
    try {
      ...
      const response = await axios.get(`${process.env.REACT_APP_SERVER_URL}/appointment/appointmentExcelFile`, {
        headers: {
              ...
              <div className="card-header align-items-center py-5 gap-2 gap-md-5">
                ...
                <div className="header-right">
                  <Link className="export-btn btn btn-primary" to={exportLink} onClick={() => handleExportData()}>
                    {/* <Link className="export-btn btn btn-primary" to={`${process.env.REACT_APP_SERVER_URL}/appointment/appointmentExcelFile`}> */}
